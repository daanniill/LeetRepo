...
export function buildProfileReadme(items = [], settings = {}) {
  ...
  const owner = settings.owner || "LeetRepo Lite user";
  ...
  const lines = [
    `# ${owner} / ${repo}`,
    "",
    "Accepted LeetCode submissions, organized by problem and language and kept up to date by LeetRepo Lite.",
    "",
    ...
    "",
    "---",
    "_Profile generated by LeetRepo Lite._"
  ];
  return lines.join("\n");
}
